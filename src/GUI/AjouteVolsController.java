...
public class AjouteVolsController implements Initializable {
    ...
    @FXML
    private Label number_error_2;
    @FXML
    private Label nom_error_2;
...
public void errorHandler(){
         ...
         annulé_error.setVisible(true);
           ...
           try {
            Integer.parseInt(num_vol.getText());
        } catch (NumberFormatException e) {
            number_error_2.setVisible(true);
        }
            try {
            Integer.parseInt(nombre_passager.getText());
        } catch (NumberFormatException e) {
            nom_error_2.setVisible(true);
        }
