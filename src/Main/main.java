...
public class main{
    ...
    //     CompagnieModel C = new CompagnieModel("DZ", "England" , "tunisair.tn" , "tunis" ,5,"Tunis","Tuniscartaghe",11,"bienvenue en tunisair");
     ...
     //  CS.deleteCompagnie("DR");
        ...
        //Avion : 
     // AvionModel A = new AvionModel("BB", "BIG" , "Alpha" , 88,"TN");
      //AvionService AS = new AvionService();
       // AS.ajouterAvion(A);
        //AS.modifierAvion("CR7",A);
    //  System.out.println(AS.afficherAvion());
     //System.out.println(AS.findByCA("b"));
     // System.out.println(AS.findByType("BIG"));
          //  System.out.println(AS.findbyModel("Alpha"));
       //     System.out.println(AS.findbyNP(88));
